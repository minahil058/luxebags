...
import { ChevronRight, LayoutGrid, List, Plus, ArrowRight, ShieldCheck, CheckCircle2, Star, Maximize2 } from "lucide-react";
...
// Always display prices as $XX.XX regardless of source format
      ...
      >
        ...
        <div className="flex-1 flex items-center justify-between">
          <div>
            ...
            <p className="text-lg font-black text-black tracking-tighter">{formatPrice(product.price)}</p>
          </div>
          <Button
            onClick={(e) => {
              e.preventDefault();
...
export default function ShopAllPage() {
  ...
  const heroImage = "https://images.unsplash.com/photo-1594223274512-ad4803739b7c?w=800&q=80";
      ...
      <div className="relative pt-32 pb-24">
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row gap-12 items-start">
            <aside className="w-full lg:w-[260px] lg:sticky lg:top-32 self-start shrink-0 z-10 space-y-6">
                  ...
                  {architecturalLinks.map((link) => (
                    <li key={link}>
                      <Link
                        ...
                        className={`flex items-center px-8 py-3.5 text-[10px] font-black transition-all uppercase tracking-widest text-zinc-500 hover:text-emerald-600 hover:bg-emerald-50/50`}
                      >
                        {link}
                      </Link>
                    </li>
              ...
              <div className="rounded-3xl border border-zinc-100 bg-white overflow-hidden shadow-sm">
                <div className="bg-zinc-900 px-8 py-5">
                  <h2 className="text-[10px] font-black tracking-[0.3em] text-white text-center uppercase">Shop By Usage</h2>
                </div>
                <ul className="py-2">
                  {usageLinks.map((link) => (
                    <li key={link}>
              ...
              <div className="p-8 rounded-3xl bg-zinc-50 border border-zinc-100 group">
              ...
              <div className="relative rounded-[2.5rem] border border-emerald-100 bg-[#f9fdfa] p-10 md:p-12 overflow-hidden flex flex-col lg:flex-row items-center gap-10 shadow-sm">
                <div className="flex-1 space-y-8 relative z-10 text-center lg:text-left">
                  <div className="space-y-4">
                    <h1 className="text-3xl md:text-5xl font-black tracking-tight text-[#1a4d2e] leading-tight uppercase">
                      All Products <br />
                      <span className="text-emerald-600 opacity-80">Full Archive</span>
                    </h1>
                  </div>
                ...
                <div className="relative w-full lg:w-[350px] aspect-square flex items-center justify-center">
                  ...
                  <Image src={heroImage} alt="All Products" fill className="object-contain drop-shadow-2xl z-10 transition-transform duration-700 hover:scale-105 p-6" />
                </div>
              </div>
